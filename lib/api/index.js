	...
	(0, _createClass3.default)(WTF, [{
		...
		value: function () {
			var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(filename) {
				var cwd, cwdData, filePath, _ref5, _ref6, executable, readable, _ref7, _ref8, fileStats, siblings, siblingsMap, info, siblingDirs, siblingFiles, useMan, siblingDirectoryReliability, siblingFileReliability;
					...
					while (1) {
						switch (_context3.prev = _context3.next) {
							...
							case 16:
								...
								fileStats = _ref8[0];
								siblings = _ref8[1];
								siblingsMap = siblings.reduce(function (map, key) {
									map[key] = true;
									return map;
								}, {});
							...
							case 23:
								info = _context3.sent;
								siblingDirs = info.siblingDirs, siblingFiles = info.siblingFiles;
								useMan = info.useMan || (!readable || executable) && _FileSystem2.default.isBinaryDirectory(cwdData.name);
