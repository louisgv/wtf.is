...
var WTF = function () {
	...
	(0, _createClass3.default)(WTF, [{
		...
		value: function calculateMatchingPercentage(theirArray, ourMap) {
			return ourMap && theirArray && theirArray[0] ? theirArray.reduce(function (p, c) {
		...
		key: "is",
		value: function () {
			var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(name) {
				var filename, cwd, cwdData, filePath, _ref5, _ref6, executable, readable, _ref7, _ref8, fileStats, siblings, siblingsMap, info, _ref9, siblingDirs, siblingFiles, useMan, siblingDirectoryReliability, siblingFileReliability;
