...
var getAndPrintData = function () {
	var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(filename, api) {
			...
			while (1) {
				switch (_context.prev = _context.next) {
					...
					case 4:
						...
						_context.next = 9;
						return _Content2.default.generateManContent(filename);
					...
					case 12:
						_context.t0 = _Content2.default.generateInfoContent(filename, data);
...
_commander2.default.command('dis <filename>').action(processFileDevMode);
